...
class WatchingView extends React.Component {
    constructor(props) {
        super(props);
    ...
    var shiftNum = this.state.numRows * this.state.numCols * this.state.pageNum;
		...
		fetch(process.env.REACT_APP_SERVER + '/getWatching', {
				credentials : 'include',
				headers: {
  ...
  render(){
    ...
    return(
			<div>
				...
				>
					<option selected="selected" value="">Number of Rows</option>
        ...
        >
					<option selected="selected" value="">Number of Columns</option>
					<option value="1">1</option>
					<option value="2">2</option>
					<option value="3">3</option>
				</select>
